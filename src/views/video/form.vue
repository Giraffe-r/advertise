<template>
  <div class="app-container">
    <el-form ref="video" :model="video" :rules="validateRules" label-width="120px">
      <el-row :gutter="20">
        <el-col :span="6">
      ...
      <el-form-item label="请输入简介" prop="description">
        <el-input type="textarea" :rows="15" placeholder="请输入简介" v-model="video.description" style="width: 100%;">
        </el-input>
      </el-form-item>
      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item label="上传视频" prop="videoSrc">
            <el-upload class="upload-demo" :action="BASE_API+'/template/video/uploadVideo'"
        ...
        <el-col :span="6">
          <el-form-item label="是否上墙" prop="onWall">
            <el-select v-model="video.onWall" placeholder="请选择">
