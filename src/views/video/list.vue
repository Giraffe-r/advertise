        ...
        <el-row>
            ...
            <el-col :span="2">
                <div style="text-align: right;">
                    <el-button type="success" @click="addVideo()" v-if="hasPerm('video.add')">添加视频</el-button>
                </div>
            </el-col>
        ...
        <el-table v-loading="listLoading" :data="list" stripe style="width: 100%">
            ...
            <el-table-column label="操作" width="300" align="center">
                <template slot-scope="scope">
                    ...
                    <el-button type="primary" size="mini" @click="editVideo(scope.row.id)">编辑</el-button>
...
export default {
    data() {
        return {
            ...
            videoForUpdate: {},
            researchPart: {},//研究部门
            videoURL:'C:/Users/14730/Desktop/video.mp4'
        }
    },
    ...
    methods: {
        ...
        //修改简介
        updateVideo() {
            videoApi.updateById(this.videoForUpdate).then((response) => {
